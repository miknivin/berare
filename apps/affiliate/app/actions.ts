...
// Mirrors the storefront's affiliate-apply flow (apps/storefront/app/
// affiliate-apply/actions.ts) so an applicant can sign up either from the
// storefront or directly here — both just insert into the same
